...
public sealed class DestroyMatchEventUIUiSystem : ICleanupSystem {

    readonly IGroup<UiEntity> _group;
    readonly List<UiEntity> _buffer = new List<UiEntity>();

    public DestroyMatchEventUIUiSystem(Contexts contexts) {
        _group = contexts.ui.GetGroup(UiMatcher.MatchEventUI);
    }
