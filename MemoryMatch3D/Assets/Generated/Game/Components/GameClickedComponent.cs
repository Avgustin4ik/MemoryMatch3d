...
public partial class GameEntity {
    ...
    static readonly Pokeball.ClickedComponent clickedComponent = new Pokeball.ClickedComponent();

    public bool triggerClicked {
        get { return HasComponent(GameComponentsLookup.Clicked); }
        set {
            if (value != triggerClicked) {
...
// </auto-generated>
//------------------------------------------------------------------------------
public partial class GameEntity : IClickedEntity { }
