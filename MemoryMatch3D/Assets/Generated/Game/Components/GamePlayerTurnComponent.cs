...
public partial class GameEntity {
    ...
    static readonly Core.GameStates.PlayerTurnComponent playerTurnComponent = new Core.GameStates.PlayerTurnComponent();

    public bool statePlayerTurn {
        get { return HasComponent(GameComponentsLookup.PlayerTurn); }
        set {
            if (value != statePlayerTurn) {
